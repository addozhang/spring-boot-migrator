...
class AddAnnotationVisitorTest {
    ...
    void visitClassDeclarationWithGenericRewriteRecipe() {
        ...
        RecipeRun run = new GenericOpenRewriteRecipe<>(() -> sut).run(new InMemoryLargeSourceSet(List.of(compilationUnit)), new InMemoryExecutionContext());
    ...
    void visitMethodDeclaration() {
        ...
        RecipeRun recipeRun = new GenericOpenRewriteRecipe<>(() -> sut).run(new InMemoryLargeSourceSet(List.of(compilationUnit)), new InMemoryExecutionContext());
