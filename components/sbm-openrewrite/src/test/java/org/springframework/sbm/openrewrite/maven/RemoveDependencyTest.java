...
public class RemoveDependencyTest {
    ...
    void deletePomTypeDependency() {
        ...
        RecipeRun run = new RemoveDependency("org.apache.tomee", "openejb-core-hibernate", null).run(new InMemoryLargeSourceSet(mavens.toList()), new InMemoryExecutionContext());
    ...
    void deleteTypeDependency() {
        ...
        RecipeRun run = new RemoveDependency("org.junit.jupiter", "junit-jupiter-api", null).run(new InMemoryLargeSourceSet(mavens.toList()), new InMemoryExecutionContext());
    ...
    void deleteJarTypeDependency() {
        ...
        RecipeRun run = new RemoveDependency("org.junit.jupiter", "junit-jupiter", "test").run(new InMemoryLargeSourceSet(mavens.toList()), new InMemoryExecutionContext());
